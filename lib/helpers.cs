...
# Generic AssignmentSet for score takers and some organizers, they should compete early.
Define(
  "EarlyAssignmentSets",
...
Define("DefaultJobs",
       [
         ...
         Job("runner", {3, Number}, eligibility=And(BooleanProperty("can-run"), EligibleToStaff())),
